...
#HARD CODED IMAGES
CONTENT_IMAGE = "content_800.png" 
STYLE_IMAGE = "pattern_800.png"
...
path_to_content_image = "/content/drive/My Drive/NST/"+CONTENT_IMAGE
path_to_style_image = "/content/drive/My Drive/NST/"+STYLE_IMAGE
...
if __name__ == "__main__":
    ...
    NST.BETA = int(sys.argv[1])
    NST.ALPHA = int(sys.argv[2])
    NST.GAMMA = int(sys.argv[3])
    NST.OUTPUT_DIR = "/../../content/drive/My Drive/NST/big_sweep/output_" + str(NST.BETA) + "_" + str(NST.ALPHA) + "_" + str(NST.GAMMA) + "/"
    if not os.path.exists(NST.OUTPUT_DIR + "1000.jpg"):
        if not os.path.isdir(NST.OUTPUT_DIR):
            os.mkdir(NST.OUTPUT_DIR)
        NST.init(IMAGE_WIDTH, IMAGE_HEIGHT, b, a, g)
        NST.run(iteration_num, style_image=path_to_style_image, content_image=path_to_content_image)
